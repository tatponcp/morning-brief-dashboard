 ...
 * Brief 14 ก.ย. 2569
 *
 *   ข้อ 1, 3, 4, 5 : IC แคปภาพจากระบบมาวางใน /studio แล้วเขียนคำอธิบาย
...
const sections: Section[] = brief20260805.sections.map((s) => {
  // ข้อ 1 และ 3: IC แคปภาพจากระบบมาวาง แล้วเขียนคำอธิบาย (ไม่วาดกราฟจากข้อมูลจำลอง)
  if (s.id === "s50-oi" || s.id === "usd-futures") {
    return {
      ...s,
      demo: false,
      mode: "image",
      source: s.id === "s50-oi" ? "TQ Pro · แคปภาพจากระบบ" : "VM · แคปภาพจากระบบ",
      contracts: undefined,
      groups: undefined,
      board: { images: [], stats: [] },
      narrative: pending,
