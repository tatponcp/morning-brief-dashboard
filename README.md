...
ปุ่มมุมขวาบนเลือกได้ 3 แบบ: **สว่าง / มืด / ตามเครื่อง** (ค่าเริ่มต้นคือมืด)
ระบบจำค่าไว้ในเบราว์เซอร์ และตั้งธีมก่อนหน้าเว็บวาด หน้าจอจึงไม่กระพริบ
รูปส่งลูกค้าจาก IC Studio ใช้ธีมที่เลือกอยู่ตอนกดสร้างรูป

สีทั้งหมดอยู่ใน `web/src/app/globals.css` — แก้สีที่เดียว เปลี่ยนทั้งเว็บ
ตัวอักษรทุกจุดผ่านเกณฑ์ contrast 4.5:1 ทั้งสองธีม
